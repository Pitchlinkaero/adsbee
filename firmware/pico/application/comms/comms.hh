...
class CommsManager {
   public:
    ...
    CPP_AT_CALLBACK(ATGPSConfigCallback);
    ...
    CPP_AT_CALLBACK(ATGPSNetworkCallback);
    CPP_AT_CALLBACK(ATGPSRTKCallback);
    CPP_AT_CALLBACK(ATGPSStaticCallback);
    CPP_AT_CALLBACK(ATGPSSBASCallback);
