...
uint16_t MQTTProtocol::FormatAircraftJSON(const ModeSAircraft& aircraft,
    ...
    int written = snprintf(buffer, buffer_size,
        ...
        band_str,
        aircraft.callsign,
        GetCategoryCode(aircraft.emitter_category_raw),  // Use standard category code
...
uint16_t MQTTProtocol::FormatUATPacketBinary(const DecodedUATADSBPacket& packet,
    ...
    // Format: [Type:1][Band:2bits|Reserved:6bits][Data:variable]
    buffer[0] = BINARY_RAW;
    buffer[1] = (BAND_978_MHZ & 0x03) << 6;  // Band in upper 2 bits
...
uint16_t MQTTProtocol::FormatAircraftBinary(const ModeSAircraft& aircraft,
    ...
    msg->spd = (uint16_t)aircraft.speed_kts & 0x3FF;
    msg->vrate = aircraft.baro_vertical_rate_fpm / 64;  // 64 fpm increments
...
const char* MQTTProtocol::GetCategoryString(ADSBTypes::EmitterCategory category) {
    switch (category) {
        case ADSBTypes::kEmitterCategoryInvalid: return "Unknown";
        case ADSBTypes::kEmitterCategoryReserved: return "Reserved";
        case ADSBTypes::kEmitterCategoryNoCategoryInfo: return "None";
        case ADSBTypes::kEmitterCategorySurfaceEmergencyVehicle: return "EmergencyVehicle";
        case ADSBTypes::kEmitterCategorySurfaceServiceVehicle: return "ServiceVehicle";
        case ADSBTypes::kEmitterCategoryPointObstacle: return "GroundObstruction";
        case ADSBTypes::kEmitterCategoryClusterObstacle: return "GroundObstruction";
        case ADSBTypes::kEmitterCategoryLineObstacle: return "GroundObstruction";
        case ADSBTypes::kEmitterCategoryGliderSailplane: return "Glider";
        case ADSBTypes::kEmitterCategoryLighterThanAir: return "Balloon";
        case ADSBTypes::kEmitterCategoryParachutistSkydiver: return "Parachutist";
        case ADSBTypes::kEmitterCategoryUltralightHangGliderParaglider: return "Ultralight";
        case ADSBTypes::kEmitterCategoryUnmannedAerialVehicle: return "UAV";
        case ADSBTypes::kEmitterCategorySpaceTransatmosphericVehicle: return "Space";
        case ADSBTypes::kEmitterCategoryLight: return "Light";
        case ADSBTypes::kEmitterCategoryMedium1: return "Medium1";
        case ADSBTypes::kEmitterCategoryMedium2: return "Medium2";
        case ADSBTypes::kEmitterCategoryHighVortexAircraft: return "HighVortex";
        case ADSBTypes::kEmitterCategoryHeavy: return "Heavy";
        case ADSBTypes::kEmitterCategoryHighPerformance: return "HighPerformance";
        case ADSBTypes::kEmitterCategoryRotorcraft: return "Rotorcraft";
